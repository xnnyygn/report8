...
(function() {
  ...
  ready = function() {
    $('.btn-modify').click(function() {
      ...
      sentence = $(this).parents('.sentence');
      sentence.find('.sentence-advice').hide();
      modified = sentence.find('.sentence-modified').html() || sentence.find('.sentence-original').html();
      sentence.find('.sentence-modified-edit').val(modified);
      sentence.find('.edit-pane').show();
      return $(this).hide();
    });
    $('.btn-cancel').click(function() {
      var sentence;
      $(this).parents('.edit-pane').hide();
      sentence = $(this).parents('.sentence');
      return sentence.find('.btn-modify').show();
    });
    $('.btn-save').click(function() {
      var modified, pane, sentence;
      pane = $(this).parents('.edit-pane');
      pane.hide();
      modified = pane.find('.sentence-modified-edit').val();
      sentence = $(this).parents('.sentence');
      sentence.find('.sentence-modified').html(modified);
      if (modified) {
        sentence.find('.sentence-advice').show();
      }
      return sentence.find('.btn-modify').show();
    });
    $('.btn-remove').click(function() {
      var advice;
      if (confirm('Do you really want to delete this advice?')) {
        advice = $(this).parents('.sentence-advice');
        advice.hide();
        return advice.find('.sentence-modified').html('');
      }
    });
    return tinymce.init({
      selector: "textarea.sentence-modified-edit",
